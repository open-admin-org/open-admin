      ...
      return function (fp) {
          return {
              ...
              onReady: function () {
                ...
                this.setMinMaxTime = function (minTime,maxTime){
                    state.defaults = {
                        minTime: new Date("2000-01-01 "+minTime),
                        maxTime: new Date("2000-01-01 "+maxTime)
                    };
                  }
                  ...
                  this.config.minTime = config.minTime;
                  this.config.maxTime = config.maxTime;
